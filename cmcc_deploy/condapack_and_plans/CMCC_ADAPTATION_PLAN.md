...
2. **修改硬编码路径**（3 个核心文件）
   ...
   **修改内容**:
   ...
   /mnt/afs/davidwang/workspace/sana_wm_pipeline/  → /root/work/david_work/sana_wm_pipeline/
...
check_dir "/root/work/david_work/sana_wm_pipeline"
...
```bash
HOSTFILE="${HOSTFILE:-/root/work/david_work/sana-wm-48-hostfiles/hostfile}"
LOCAL_DIR="${LOCAL_DIR:-/root/work/david_work/sana_wm_pipeline}"
```
