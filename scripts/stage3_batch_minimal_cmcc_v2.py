...
def compute_dover_score(video_path, model, dopt, temporal_samplers, device):
    ...
    if H > 720:
        ...
        tmp_fd, tmp_path = tempfile.mkstemp(suffix='.mp4', dir=str(tmp_dir))
        os.close(tmp_fd)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Stage3 视频质量筛选 - CMCC适配版（100%对齐原始逻辑）")
